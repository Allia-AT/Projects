...
public class PaymentDatabase extends Database{
  ...
  /**
   * Returns the unsorted HashMap
   * 
   * @return this.custToPayment Map<String,Double> the unsorted map of every customer
   * 	to their total payments
   */
  public Map<String,Double> getCustToPayment(){
	  @Nullable ResultSet set;
	  String query = "SELECT * FROM payment;";
	  set = super.query(query);
	  this.makeHashMap(set);
	  return this.custToPayment;
  }
}
